...
getCohortTableNames <- function(cohortTable = "cohort",
                                cohortInfoTable = paste0(cohortTable, "_info")) {
  return(list(
    cohortTable = cohortTable,
    cohortInfoTable = cohortInfoTable
  ))
}
...
createCohortTables <- function(connectionDetails = NULL,
  ...
  sql <- SqlRender::render(
    ...
    cohort_name_table = cohortTableNames$cohortInfoTable,
...
getCohortNamesFromCohortTable <- function(connectionDetails = NULL,
                                          connection = NULL,
                                          cohortDatabaseSchema,
                                          cohortTableNames = getCohortTableNames()){
