...
a <- CohortTableHandler$new(
  database_settings$connectionDetails, 
  database_settings$schemas$vocab,
  database_settings$schemas$CDM,
  database_settings$schemas$scratch
  )
